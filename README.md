This is the Backend for a blog application. It uses Nodejs,ExpresJs and connects to mongoAtlas. the frontend for it is also uploaded in a github repo,you can check it out on my profile.
